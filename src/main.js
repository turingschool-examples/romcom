...
function saveCover() {
  if (savedCovers.length === 0) {
    currentCover = createCover('', '', '', ''); // Assign an empty cover
  }
...
function makeRandomCover() { // Updates the Data Model (currentCover)
  currentCover =  createCover(covers[getRandomIndex(covers)], 
